...
<head>
    ...
    <script type="text/javascript">
        ...
        function emailsubmit() {
            ...
            $.post("${pageContext.request.contextPath}/user/validateEmailCode", $("#validateEmailCode").serialize(), function (date) {
                if (date == "success") {
                    location.href = "${pageContext.request.contextPath}/user/showResetPassword";
                    return true;
                } else {
                    alert("验证码错误");
                    return false;
...
<main>
    <div class="container">
        <form class="ma" id="validateEmailCode" action="${pageContext.request.contextPath}/user/validateEmailCode">
            ...
            <div class="form_body">
                ...
                <input type="text" placeholder="请输入验证码" id=code name="code"><input type="button" id="yzmBtn"
                                                                                   value="获取验证码"/>
                <input type="submit" onclick="return emailsubmit()" value="提交">
            </div>
