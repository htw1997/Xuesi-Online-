...
<body class="w100">
    ...
    <nav class="w100">
        <div class="container">
            <img src="${pageContext.request.contextPath}/img/xuesi.png" alt="学思网教育的logo" onclick="location.href='${pageContext.request.contextPath}/index.jsp'" draggable="false">
    ...
    <div id="app" >
        ...
        <!--面包屑导航-->
        <div class="container mian-nav">艺术课 / ${subject.subjectName}</div>
                    ...
                    <ul>
                        ...
                        <c:forEach items="${course.videoList}" var="video" varStatus="i" >
                                 <li class="section-main"  onclick="getVideo(${video.id})">
		                            <div class="thum" style="background-image: url('../${video.coverPath}')">
        ...
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="loginForm" action="#">
                    <h3>快速登录</h3>
                    <input type="phone" id="loginEmail" placeholder="请输入手机号" name="email">
