...
<div class="videolike" style="margin-top: 10px;">
    ...
    简介:
    <div class="layui-inline">
        <input class="layui-input" name="courseDesc" id="courseDesc" autocomplete="off">
    </div>
...
<script type="text/html" id="bar">
    ...
    <div class="layui-btn-group">
        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" lay-event="add" if="${user.rId} == 'admin'">
            <i class="layui-icon">&#xe654;</i>
        </button>
        &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="layui-btn-group" if="${user.rId} == 'admin'">
...
<script type="text/html" id="barDemo">
    <c:if test="${user.rId == 'admin' }">
    <a class="layui-btn layui-btn-xs" lay-event="edit" if="${user.rId} == 'admin'">编辑</a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" if="${user.rId} == 'admin'">删除</a>
    </c:if>
</script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js1/course.js" th:src="@{/js1/course.js}"></script>
</html>